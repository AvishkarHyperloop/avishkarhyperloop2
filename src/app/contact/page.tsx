...
import {
  ...
  Linkedin, Instagram, Twitter, Youtube, Facebook, Terminal
} from "lucide-react";
...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-tl from-[#101010] via-[#080808] to-[#1a3a29] text-white font-sans selection:bg-green-500/30 overflow-x-hidden relative">
        ...
        <div className="absolute inset-0">
          {[...Array(15)].map((_, i) => (
            <motion.div
              ...
              className="absolute w-[3px] h-[3px] bg-green-500 rounded-full"
        ...
        <div className="grid lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-5 space-y-10">
            <div>
              ...
              />
              <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-white leading-tight uppercase italic">
                GET IN <span className="text-green-500 drop-shadow-xl">TOUCH</span>
              </h1>
            ...
            <div className="p-6 rounded-2xl border border-green-500/20 bg-green-500/5 hidden lg:block">
              ...
              <p className="font-semibold text-gray-300">Email: avishkarhyperloop@smail.iitm.ac.in</p>
          ...
          <div className="lg:col-span-7">
            <form
              ...
              className="bg-black/30 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-12 shadow-xl space-y-10 relative overflow-hidden"
            >
              ...
              <div className="space-y-3">
                ...
                <select
                  ...
                  className="w-full bg-black/50 border border-white/10 p-4 rounded-xl text-white outline-none focus:border-green-500 transition-all cursor-pointer"
                >
              ...
              <div className="space-y-3">
                ...
                <textarea
                  ...
                  className="w-full bg-black/50 border border-white/10 p-4 rounded-xl text-white outline-none focus:border-green-500 transition-all resize-none placeholder:text-white/10"
                  required
                />
              </div>
              ...
              <AnimatePresence>
                {status === "success" && (
                  <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-green-500 text-center font-mono text-xs uppercase tracking-widest mt-4">Message Delivered Successfully</motion.p>
                )}
              </AnimatePresence>
            </form>
          </div>
