    ...
    <div className="w-full min-h-screen bg-[#050505] text-white selection:bg-green-500 selection:text-black font-sans overflow-x-hidden relative">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        <motion.div 
          ...
          className="absolute left-0 right-0 h-[1px] bg-green-500/20 z-10"
        />
      </div>

      {/* ================= CONTENT LAYER (TEXT IN FRONT) ================= */}
      <div className="relative z-10">
        ...
        {/* HERO SECTION */}
        <section className="relative h-screen flex items-center justify-center overflow-hidden border-b border-white/5 bg-black/40 backdrop-blur-[2px]">
        ...
        <section className="relative py-32 px-6 max-w-7xl mx-auto">
          <div className="flex flex-col mb-16 space-y-2 text-center md:text-left">
            ...
            <p className="text-gray-400 font-light max-w-xl">Strict breakdown of the 7 primary engineering domains enabling sub-vacuum transit.</p>
          </div>
...
[Image of linear induction motor working principle]
"
        ...
        {/* FOOTER */}
        <footer className="py-24 border-t border-white/5 bg-black relative z-20 px-6 text-center">
...
function SubsystemTile({ icon, title, desc }: any) {
  return (
    <motion.div
      ...
      className="p-8 border border-white/5 bg-black/60 backdrop-blur-md transition-all group relative overflow-hidden"
    >
...
function SystemSection({ title, icon, content, images, reverse, specs, diagramTag }: any) {
  return (
    <section className="py-40 px-6 max-w-7xl mx-auto relative z-10">
      <div className={`flex flex-col ${reverse ? 'lg:flex-row-reverse' : 'lg:flex-row'} gap-24 items-start`}>
        <div className="lg:w-1/2">
          ...
          <p className="text-xl text-gray-400 font-light leading-relaxed mb-6">{content}</p>
          
          {diagramTag && (
            <div className="mb-10 p-4 border border-green-500/10 rounded-lg bg-green-500/5">
              <p className="text-[10px] font-mono text-green-500/60 uppercase mb-4 tracking-widest text-center">Schematic_Overview</p>
              {diagramTag}
            </div>
          )}
